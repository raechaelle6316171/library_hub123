...
public class issuereport_management extends javax.swing.JFrame {
    ...
    public void populateIssueReport(String searchName) {
    ...
    try {
        ...
        // Removed "ORDER BY id" to stop the error
        String sql = "SELECT * FROM issued_bookstry WHERE fullname LIKE ?";
        ...
        while (rs.next()) {
            // Note: If 'id' is still the wrong name, we use the first column (1)
            Object[] row = {
                rs.getString(1),             // This gets whatever your first column is
            ...
            model.addRow(row); // Capital R fixed!
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Full Name", "User Type", "Course", "Year", "Book Title", "Acq No", "Issued Date", "Due Date", "Actual Return Date", "Penalty Paid", "Status"
            }
        ) {
