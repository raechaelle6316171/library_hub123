...
public class user_management_copy extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(user_management_copy.class.getName());

    public user_management_copy() {
        initComponents();
        showTableData();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new user_management_copy().setVisible(true));
    }
